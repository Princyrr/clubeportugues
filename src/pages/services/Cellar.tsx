...
const Cellar = () => {
  const activities = [
    ...
    { title: "Tai Chi Chuan", teacher: "Prof. Júlio Kushida", image: tai, contact: "(81) 98608-1584" },
    { title: "Kung Fu", teacher: "Prof. Júlio Kushida", image: kung, contact: "(81) 98608-1584" },
