...
const NoticiasSection = () => {
  const noticias = [
    ...
    { img: noticia13, title: 'Orgulho Luso no Handebol', description: 'Quatro jogadoras formadas no FMO/Clube Português foram convocadas para a Seleção Brasileira de Handebol!' },
