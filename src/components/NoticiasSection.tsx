...
const NoticiasSection = () => {
  const noticias = [
    ...
    { img: noticia2, title: 'Técnica Convocada', description: 'Treinadora do Clube Português do Recife, Keycy Florêncio, foi convocada para integrar a Seleção Brasileira de Natação.' },
